...
# --- Configuration ---
FULL_MODEL_PATH = 'sign_language_model.h5'
...
try:
    # --- WARNING: Avoid hardcoding keys. Use environment variables or a config file. ---
    GEMINI_API_KEY = "AIzaSyDZyAaDqjl2ef2dLKyykhsh6QY-GEiBECI" # <<< REPLACE THIS WITH YOUR ACTUAL KEY >>>
    if GEMINI_API_KEY == "AIzaSyDZyAaDqjl2ef2dLKyykhsh6QY-GEiBECI":
        print(f'---------------------\n')
        # Optional: exit if key is missing
        # sys.exit("Gemini API Key not set. Exiting.")
